...
import { ValidationError } from "../n_components/ValidationError";
type Contact = {
  name: string;
  email: string;
  reason: string;
...
export function ContactPage() {
  ...
  //function to style field validation
  function getEditorStyle(fieldError: FieldError | undefined) {
    return fieldError ? "border-red-500" : "";
  }
  return (
    <div className="flex flex-col py-10 max-w-md mx-auto text-black">
      <h2 className="text-3xl font-bold underline mb-3">Contact Us</h2>
      <p className="mb-3">
        If you enter your details we'll get back to you as soos as we
      </p>
